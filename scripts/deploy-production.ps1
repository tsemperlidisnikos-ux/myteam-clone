...
Write-Host "  2. Copy connection string - append ?sslmode=require if missing"
...
Write-Host "  Set FRONTEND_URL in Railway = your Vercel URL for CORS"
...
Write-Host "  Open Vercel URL and login"
Write-Host ""

Write-Host "Optional GitHub Actions deploy after manual setup:" -ForegroundColor DarkGray
Write-Host "  Secrets: RAILWAY_TOKEN, VERCEL_TOKEN, VERCEL_ORG_ID, VERCEL_PROJECT_ID, VITE_API_URL"
Write-Host "  Run workflow: Deploy"
Write-Host ""
